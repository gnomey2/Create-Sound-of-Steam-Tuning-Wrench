...
declare namespace Internal {
    ...
    interface IEServerWorld {
        abstract ip_getEntityManager(): Internal.PersistentEntitySectionManager<Internal.Entity>;
        (): Internal.PersistentEntitySectionManager_<Internal.Entity>;
    }
    type IEServerWorld_ = (()=> Internal.PersistentEntitySectionManager_<Internal.Entity>) | IEServerWorld;
    ...
    */
    ...
    class LootDataManager implements Internal.LootDataResolver, Internal.PreparableReloadListener, Internal.LootTablesKJS {
        ...
        notify(): void;
        wait(arg0: number, arg1: number): void;
        handler$zja000$apply(parsedMap: Internal.Map_<any, any>, ci: Internal.CallbackInfo_): void;
    ...
    class EExtensionShapes$QuadrupleShape extends Internal.Enum<Internal.EExtensionShapes$QuadrupleShape> implements Internal.EExtensionShapes$ExtensionShape, Internal.StringRepresentable {
        static valueOf<T extends Internal.Enum<T>>(arg0: T, arg1: string): T;
        getClass(): typeof any;
        static fromEnumWithMapping<E extends Internal.Enum<E> & Internal.StringRepresentable>(arg0: Internal.Supplier_<E[]>, arg1: Internal.Function_<string, string>): Internal.StringRepresentable$EnumCodec<E>;
        toString(): string;
        getSerializedName(): string;
        getDeclaringClass(): typeof Internal.EExtensionShapes$QuadrupleShape;
        notifyAll(): void;
        notify(): void;
        wait(arg0: number, arg1: number): void;
        compareTo(arg0: any): number;
        name(): string;
        describeConstable(): Internal.Optional<Internal.Enum$EnumDesc<Internal.EExtensionShapes$QuadrupleShape>>;
        hashCode(): number;
        "compareTo(com.finchy.pipeorgans.content.pipes.generic.EExtensionShapes$QuadrupleShape)"(arg0: Internal.EExtensionShapes$QuadrupleShape_): number;
        static values(): Internal.EExtensionShapes$QuadrupleShape[];
        static keys(arg0: Internal.StringRepresentable_[]): Internal.Keyable;
        static fromEnum<E extends Internal.Enum<E> & Internal.StringRepresentable>(arg0: Internal.Supplier_<E[]>): Internal.StringRepresentable$EnumCodec<E>;
        ordinal(): number;
        wait(): void;
        compareTo(arg0: Internal.EExtensionShapes$QuadrupleShape_): number;
        wait(arg0: number): void;
        "compareTo(java.lang.Object)"(arg0: any): number;
        equals(arg0: any): boolean;
        static valueOf(arg0: string): Internal.EExtensionShapes$QuadrupleShape;
        get class(): typeof any
        get serializedName(): string
        get declaringClass(): typeof Internal.EExtensionShapes$QuadrupleShape
        static readonly DOUBLE: (Internal.EExtensionShapes$QuadrupleShape) & (Internal.EExtensionShapes$QuadrupleShape);
        static readonly QUAD_CONNECTED: (Internal.EExtensionShapes$QuadrupleShape) & (Internal.EExtensionShapes$QuadrupleShape);
        static readonly SINGLE: (Internal.EExtensionShapes$QuadrupleShape) & (Internal.EExtensionShapes$QuadrupleShape);
        static readonly TRIPLE: (Internal.EExtensionShapes$QuadrupleShape) & (Internal.EExtensionShapes$QuadrupleShape);
        static readonly QUAD: (Internal.EExtensionShapes$QuadrupleShape) & (Internal.EExtensionShapes$QuadrupleShape);
    }
    type EExtensionShapes$QuadrupleShape_ = "double" | EExtensionShapes$QuadrupleShape | "single" | "quad" | "quad_connected" | "triple";
    class FoodData {
        constructor()
        getClass(): typeof any;
...
declare namespace com.simibubi.create.content.trains.schedule {
    class Schedule {
        ...
        cyclic: boolean;
        static CONDITION_TYPES: ([net.createmod.catnip.data.Pair<any, any>, net.createmod.catnip.data.Pair<any, any>, net.createmod.catnip.data.Pair<any, any>, net.createmod.catnip.data.Pair<any, any>, net.createmod.catnip.data.Pair<any, any>, net.createmod.catnip.data.Pair<any, any>, net.createmod.catnip.data.Pair<any, any>, net.createmod.catnip.data.Pair<any, any>, net.createmod.catnip.data.Pair<any, any>]) & (Internal.List<net.createmod.catnip.data.Pair<ResourceLocation, Internal.Supplier<Internal.ScheduleWaitCondition>>>);
    }
